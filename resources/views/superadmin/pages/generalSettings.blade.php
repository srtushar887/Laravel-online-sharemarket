...
@section('superadmin')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" novalidate="" action="{{route('superadmin.general.settings.update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="validationCustom01">Site Maintanace Message</label>
                                    <textarea type="password" name="maintanance_message" class="form-control" id="exampleInputPassword1" autocomplete="off" placeholder="">{!! $gen->maintanance_message !!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="validationCustom01">Is Site Under Maintanace</label>
                                    <select class="form-control" name="is_maintanance">
                                        <option value="0">select any</option>
                                        <option value="1" {{$gen->is_maintanance == 1 ?'selected' : ''}}>On</option>
                                        <option value="2" {{$gen->is_maintanance == 2 ?'selected' : ''}}>Off</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="validationCustom01">Is Maintanace Message Show</label>
                                    <select class="form-control" name="is_maintanance_message_show">
                                        <option value="0">select any</option>
                                        <option value="1" {{$gen->is_maintanance_message_show == 1 ?'selected' : ''}}>On</option>
                                        <option value="2" {{$gen->is_maintanance_message_show == 2 ?'selected' : ''}}>Off</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="validationCustom01">User Email Verification</label>
                                    <select class="form-control" name="is_email_verify">
                                        <option value="0">select any</option>
                                        <option value="1" {{$gen->is_email_verify == 1 ?'selected' : ''}}>On</option>
                                        <option value="2" {{$gen->is_email_verify == 2 ?'selected' : ''}}>Off</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="logo" class="form-control" id="exampleInputPassword1" autocomplete="off" placeholder="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
