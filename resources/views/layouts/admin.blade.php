        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box" style="background-color: #ffffff">
                    ...
                    <a href="{{route('admin.dashboard')}}" class="logo logo-light" style="font-size: 25px">
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block user-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{route('admin.change.password')}}"><i class="ri-lock-unlock-line align-middle mr-1"></i> Lock screen</a>
        ...
        <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('admin.user.plans')}}" class=" waves-effect">
                            <i class="ri-chat-1-line"></i>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('admin.withdraw.pending')}}">Pending</a></li>
                            <li><a href="{{route('admin.withdraw.confirmed')}}">Confirmed</a></li>
                            <li><a href="{{route('admin.withdraw.rejected')}}">Rejected</a></li>
                        </ul>
                    </li>
