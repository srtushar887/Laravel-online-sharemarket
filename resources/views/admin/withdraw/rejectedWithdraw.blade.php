...
@section('admin')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Rejected Withdraw Request</h4>
        </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($user_withs as $userwith)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-icon" data-toggle="modal" data-target="#admineditwith{{$userwith->id}}">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button type="button" class="btn btn-danger btn-icon" data-toggle="modal" data-target="#admindeletewith{{$userwith->id}}">
                                ...
                                <div class="modal fade" id="admineditwith{{$userwith->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{route('admin.withdraw.status.save')}}" method="post">
                                                @csrf
