                        ...
                        <table class="table mb-0">
                            ...
                            @foreach($plans as $plan)
                                <tr>
                                    ...
                                    <th>{{$gn->site_currency}}{{$plan->plan_amount}}</th>
                                            ...
                                            <form action="{{route('admin.plan.update')}}" method="post">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Enter Plan Amount" name="plan_amount" value="{{$plan->plan_amount}}">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="plan_type">
                                                            ...
                                                            <option value="1" {{$plan->plan_type == 2 ? 'selected' : ''}}>Normal Plan</option>
                                                            <option value="2" {{$plan->plan_type == 3 ? 'selected' : ''}}>Special Plan</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Status</label>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Plan Amount</label>
                        <input type="number" class="form-control" placeholder="Enter Plan Amount" name="plan_amount">
                    </div>
                    <div class="form-group">
                        <label>Return Date (EX : 7)</label>
