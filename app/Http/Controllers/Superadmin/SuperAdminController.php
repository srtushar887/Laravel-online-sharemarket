...
class SuperAdminController extends Controller
{
    public function index()
    {
        ...
        return view('superadmin.index',compact('total_user','total_withdraw','user_invest_plan','latest_users'));
    }
    ...
    public function general_setting_save(Request $request)
    {
        ...
        $gen->maintanance_message = $request->maintanance_message;
        $gen->is_maintanance = $request->is_maintanance;
        $gen->is_maintanance_message_show = $request->is_maintanance_message_show;
        $gen->is_email_verify = $request->is_email_verify;
        $gen->save();
    ...
    {
        $profile_update = SuperAdmin::where('id',Auth::user()->id)->first();
    ...
    {
        return view('superadmin.pages.changePass');
    }
    ...
    public function change_password_save(Request $request)
    {
        if ($request->npas != $request->cpass) {
            ...
            $user = SuperAdmin::where('id', Auth::user()->id)->first();
