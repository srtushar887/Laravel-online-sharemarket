...
class SuperAdminPlanController extends Controller
{
    public function plans()
    {
        ...
        return view('superadmin.plans.planList',compact('plans'));
    }
    ...
    public function plans_save(Request $request)
    {
        ...
        $new_plan->plan_min_amount = $request->plan_min_amount;
        $new_plan->plan_max_amount = $request->plan_max_amount;
    ...
    public function plans_update(Request $request)
    {
        ...
        $plan_update->plan_min_amount = $request->plan_min_amount;
        $plan_update->plan_max_amount = $request->plan_max_amount;
    ...
    public function user_plans()
    {
        ...
        return view('superadmin.plans.userPlanList',compact('user_plans'));
    }
...
//                $plan_type_update->first_date = Carbon::now('Asia/Dhaka')->addMinutes(2);
//                $plan_type_update->second_date = Carbon::now('Asia/Dhaka')->addMinutes(2);
//                $plan_type_update->third_date = Carbon::now('Asia/Dhaka')->addMinutes(2);
//                $plan_type_update->return_date = Carbon::now('Asia/Dhaka')->addMinutes(2);
